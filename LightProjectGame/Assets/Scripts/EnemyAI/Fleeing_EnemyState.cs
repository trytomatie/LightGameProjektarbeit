...
public class Fleeing_EnemyState : State
{
    ...
    {
        if (esv.LightsInRange.Count > 0 && (esv.stateMachine.currentState.stateName != StateName.Hurt && esv.stateMachine.currentState.stateName != StateName.Dead) && !esv.emboldend)
        {
